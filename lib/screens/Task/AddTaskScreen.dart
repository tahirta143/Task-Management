...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  Future<void> _createTask() async {
    ...
    try {
      ...
      // Generate days array instead of subTasks
      print('=== GENERATING DAYS ARRAY ===');
      final days = _generateDays();
      print('Generated ${days.length} days');
      ...
      final success = await taskProvider.createTask(
        ...
        priority: _selectedPriority,
        tags: _tags,
        days: days, // Changed from subTasks to days
      );
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Task Duration Info - Updated message
                      _buildDurationInfo(isSmallScreen),
                      SizedBox(height: 24),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  '$days daily sub-tasks will be created automatically',
                  style: TextStyle(
                    fontSize: isSmallScreen ? 12 : 13,
                    color: Colors.blue[600],
                  ),
